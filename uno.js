...
function mostrar() {
	...
	if (temperatura < 35 || temperatura > 40) {
		alert(" a0 temperatura incorrecta");
	}

	else if (temperatura >= 38) {
		alert(" a1 permiso no otorgado");
	}
	else if (sintoma == "Tos" && temperatura <= 37) {
		alert("a2 permiso otorgado");
	}
	else if (sintoma == "PerdidaOlfato" || sintoma == "PerdidaGusto" && temperatura < 38) {
		alert("a3 Permiso otorgado")
	}
	else if (sintoma == "DificultadParaRespirar" && temperatura < 38) {
		alert("a4 Permiso no otorgado");
	}
	else {
		alert("a5 permiso otorgado");
	}
